...
class Config(object):
    ...
    def __init__(self, args):
        ...
        self.train_imgs_meta_path = args.train_imgs_meta_path
        self.val_1_imgs_meta_path = args.val_1_imgs_meta_path
        self.val_2_imgs_meta_path = args.val_2_imgs_meta_path
...
def main(cfg):
    ...
    # print(train_dataset.trg_voc_size,'\n\n\n\n')
    model = SubsAudioVideoTransformer(
        train_dataset.trg_voc_size, train_dataset.subs_voc_size,
        train_dataset.imgs_voc_size,
        cfg.d_aud, cfg.d_vid, cfg.d_model_audio, cfg.d_model_video,
        cfg.d_model_subs,cfg.d_model_imgs,
        cfg.d_ff_audio, cfg.d_ff_video, cfg.d_ff_subs, cfg.d_ff_imgs,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--train_meta_path', type=str, default='./data/train_imgs_meta.csv',
        help='path to the precalculated train meta file'
    )
    parser.add_argument(
        '--train_imgs_meta_path', type=str, default='./data/train_imgs_meta.csv',
        help='path to the precalculated train meta file'
    )

    parser.add_argument(
        '--val_1_meta_path', type=str, default='./data/val_1_imgs_meta.csv',
        help='path to the precalculated val 1 meta file'
    )
    parser.add_argument(
        '--val_1_imgs_meta_path', type=str, default='./data/val_1_imgs_meta.csv',
        help='path to the precalculated val 1 meta file'
    )
    parser.add_argument(
        '--val_2_meta_path', type=str, default='./data/val_2_imgs_meta.csv',
        help='path to the precalculated val 2 meta file'
    )
    parser.add_argument(
        '--val_2_imgs_meta_path', type=str, default='./data/val_2_imgs_meta.csv',
        help='path to the precalculated val 2 meta file'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--modality', type=str, default='imgs_subs_audio_video',
        choices=['audio', 'video', 'audio_video', 'subs_audio_video','imgs_subs_audio_video'],
    )
    ...
    parser.add_argument('--d_model_imgs', type=int, default=512)
    parser.add_argument(
    ...
    parser.add_argument(
        '--d_ff_imgs', type=int, default=2048,
        help='size of the internal layer of PositionwiseFeedForward net in Transformer (imgs)'
    )
    parser.add_argument(
        '--B', type=int, default=64,
        help='batch size per a device'
    )
    parser.add_argument(
        '--inf_B_coeff', type=int, default=4,
